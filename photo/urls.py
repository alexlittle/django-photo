...
urlpatterns = [
    ...
    path('scan/', photo_views.scan_folder, name="scan"),
    ...
    path('album/<int:album_id>/exif', photo_views.album_exif, name="album_exif"),
    ...
    path('photo/edit/<int:photo_id>', photo_views.photo_edit_view, name="edit"),
    path('photo/star/<int:photo_id>', photo_views.photo_star_view, name="star"),
    path('photo/unstar/<int:photo_id>', photo_views.photo_unstar_view, name="unstar"),
    path('photo/favourites/', photo_views.photo_favourites_view, name="favourites"),

    path('photo/view/annotated/<int:photo_id>.jpg', photo_views.PhotoViewAnnotated.as_view(), name="view_annotated"),

    path('photo/setcover/<int:photo_id>', photo_views.photo_set_cover, name="set_cover"),
    path('album/updatetags/', photo_views.photo_update_tags, name="update_tags"),

    path('export/', include('photo.export.urls')),
    path('scan/async', photo_views.scan_folder_async, name='scan_folder_async'),
]
