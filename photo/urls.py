...
urlpatterns = [
    ...
    path(
        "album/<int:album_id>/exif/", photo_views.AlbumExifUpdateView.as_view(), name="album_exif"
    ),
    ...
    path(
        "photo/view/annotated/<int:photo_id>.jpg",
        photo_views.PhotoViewAnnotated.as_view(),
        name="view_annotated",
    ),
    path(
        "photo/setcover/<int:photo_id>/", photo_views.PhotoSetCoverView.as_view(), name="set_cover"
    ),
